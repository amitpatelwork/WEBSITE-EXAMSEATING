...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="css/addmision2.css">
  </head>
  <body>

    <nav id="navbar">
        <div id="logo">
            <img src="images/logo_new.png" alt="error"> 
        </div>
...
<b>
  ...
  if ($result->num_rows > 0) {
    ...
    $i=1;
  echo "<table border='5' width='1500px'><tr><th>Sr. No.</th><th>DATE</th><th>LACTURE_NO</th><th>SUBJECT</th><th>ATTENDANCE_STATUS</th><th>TEACHER_NAME</th></tr>";
