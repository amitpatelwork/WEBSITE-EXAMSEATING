...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="container">
        <div class="innerdiv">
            <div class="row"><img class="imglogo" src="images/logo3.png"/></div>
            ...
            <div>Branch:<input type="radio" name="branch" value="other"/>other<input type="radio" name="branch" value="BSIT"/>computer<div style="margin-left:80px"><input type="radio" name="branch" value="BSCS"/>commerce<input type="radio" name="branch" value="BSSE"/>Bio</div>
            </div>   
